...
import { clearAll } from '../engine/store/db';
    ...
    <div>
      ...
      <div className="card">
        ...
        <p className="small muted">
          {registered} registro{registered === 1 ? '' : 's'} guardado{registered === 1 ? '' : 's'} neste aparelho. Nada
          e enviado para nenhum servidor, exceto as fotos, quando a identificacao assistida esta ligada.
        </p>
        {confirmClear ? (
          <div className="stack">
